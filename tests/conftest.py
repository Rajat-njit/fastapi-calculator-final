...
def client(db_session):
    ...
    This overrides the app's get_db dependency so all API calls
    in tests use the TestingSessionLocal / db_session fixture.
    """
    def override_get_db():
        try:
            yield db_session
        finally:
            # Session cleanup is handled by db_session fixture
            pass
